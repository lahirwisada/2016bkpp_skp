                                    ...
                                    <?php if ($records != FALSE): ?>
                                        <?php foreach ($records as $key => $record): ?>
                                            <tr>
                                                ...
                                                <td><?php echo beautify_str($record->nama_atasan_pejabatpenilai) ?></td>
                                                <td><?php echo beautify_str($record->nama_pejabat_penilai) ?></td>
												<td><?php echo beautify_str($record->nama_yang_dinilai) ?></td>
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        <a class="btn btn-default" href="<?php echo base_url("back_end/" . $active_modul . "/detail") . "/" . $record->id_pejabat_penilai; ?>">Ubah</a>
                                                        <a class="btn btn-default btn-hapus-row" href="javascript:void(0);" rel="<?php echo base_url("back_end/" . $active_modul . "/delete") . "/" . $record->id_pejabat_penilai; ?>">Hapus</a>
                                                    </div>
                                                </td>
                                            </tr>
